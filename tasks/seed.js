...
import {
	dbConnection,
	closeConnection,
} from '../config/mongodb/mongoConnection.js';

const db = await dbConnection();
await db.dropDatabase();

// Create 10 accounts
const Tanav = await userData.createUser(
	'TanavT',
	'Tanav',
	'Thota',
	'tanavthota@gmail.com',
	'Password123!',
	'20',
	'2004-06-24'
);
const Chris = await userData.createUser(
	'ChrisBrown',
	'Chris',
	'Brown',
	'cbrown19@notstevens.edu',
	'Test!ngDIFFERENTPassword098',
	'21',
	'2003-10-23'
);
const Mylo = await userData.createUser(
	'Mylo',
	'Mylo',
	'Thota',
...
const Logan = await userData.createUser(
	'ltripler',
	'Logan',
	'Tripler',
	'logantripler@example.com',
	'P@sswd123',
	'20',
	'2002-12-07'
);
const JustinK = await userData.createUser(
	'jkwak',
	'Justin',
	'Kwak',
	'justinkwak@example.com',
	'P@ssw0d123',
	'21',
	'2005-06-24'
);
const JustinF = await userData.createUser(
	'jfarley',
	'Justin',
	'Farley',
	'justinfarley@example.com',
	'Pa$$wor23',
	'21',
	'2003-07-24'
);
const Peter = await userData.createUser(
	'pparker',
	'Peter',
	'Parker',
...
const Sam = await userData.createUser(
	'ssulek',
	'Sam',
	'Sulek',
	'samsulek@example.com',
	'P@ssw12E',
	'23',
	'2002-11-04'
);
const Rock = await userData.createUser(
	'trock',
	'The',
	'Rock',
	'therock@example.com',
...
const Mike = await userData.createUser(
	'mtyson',
	'Mike',
	'Tyson',
	'miketyson@example.com',
	'Pas0rd!23',
	'58',
	'2003-10-19'
);
const Willy = await userData.createUser(
	'wwonka',
	'Willy',
	'Wonka',
	'willywonka@example.com',
	'P@sord123*',
	'47',
	'2001-01-27'
);
